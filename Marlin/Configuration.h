...
#define STRING_CONFIG_H_AUTHOR "(Tejas Maraliga, SKR 2 Hypercube)" // Who made the changes.
 ...
 * :[-2, -1, 0, 1, 2, 3, 4, 5, 6, 7]
 */
//GM - enable serial port for connecting to host
...
#define CUSTOM_MACHINE_NAME "Sidewinder IIa"
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  // from FOPDT model - kp=.39 Tp=405 Tdead=66, Tc set to 79.2, aggressive factor of .15 (vs .1, 1, 10)
    ...
    // [gm] M303 E-1 C8 S65   11Jul2021
  #define DEFAULT_bedKp 125.75
  #define DEFAULT_bedKi 25.12
  #define DEFAULT_bedKd 419.57
 ...
 */
//#define Z_MIN_PROBE_USES_Z_MIN_ENDSTOP_PIN [Uncommented beecause bltouch is being used - TM]
 ...
 */
//#define Z_MIN_PROBE_PIN 32 // Pin 32 is the RAMPS default [Leave commented so SKR uses default PE4]
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 30, 18, -1.9 }
